...
var _ModelSettingJson = require("./lib/ModelSettingJson");
                ...
                thisRef.loadTexture(i, texPaths, function () {
                    ...
                    if (thisRef.isTexLoaded) {
                        ...
                        if (thisRef.modelSetting.getHitAreasCustom() != null) {
                            ...
                            if (hit_areas_custom["head_x"] != null) _LAppDefine2.default.hit_areas_custom_head_x = hit_areas_custom["head_x"];
                            if (hit_areas_custom["head_y"] != null) _LAppDefine2.default.hit_areas_custom_head_y = hit_areas_custom["head_y"];
                            if (hit_areas_custom["body_x"] != null) _LAppDefine2.default.hit_areas_custom_body_x = hit_areas_custom["body_x"];
                            if (hit_areas_custom["body_y"] != null) _LAppDefine2.default.hit_areas_custom_body_y = hit_areas_custom["body_y"];
                        }
                        ...
                        thisRef.preloadMotionGroup(_LAppDefine2.default.MOTION_GROUP_SLEEPY);
...
LAppModel.prototype.update = function () {
    ...
    if (this.mainMotionManager.isFinished()) {
        ...
        if (Sleepy === '1') {
            this.startRandomMotion(_LAppDefine2.default.MOTION_GROUP_SLEEPY, _LAppDefine2.default.PRIORITY_SLEEPY);
        } else {
...
LAppModel.prototype.hitTestCustom = function (type, testX, testY) {
    if (type == 'head') {
        return this.hitTestSimpleCustom(_LAppDefine2.default.hit_areas_custom_head_x, _LAppDefine2.default.hit_areas_custom_head_y, testX, testY);
    } else if (type == 'body') {
        return this.hitTestSimpleCustom(_LAppDefine2.default.hit_areas_custom_body_x, _LAppDefine2.default.hit_areas_custom_body_y, testX, testY);
    } else {
        return false;
    }
};